...
public function addNoteT() {
	...
	public function setEnTete() {
		...
		$this->_page->drawText ( 'Saint-Louis le, ' . $dateNow, 510, $this->_pageHeight - 50 );
		
		$this->_yPosition -= 35;
		$this->_page->setFont ( $this->_newTime, 15 );
		$this->_page->setFillColor ( new ZendPdf\Color\Html ( 'green' ) );
		$this->_page->drawText ( 'Demande de transfert', $this->_leftMargin + 200, $this->_yPosition );
		$this->_yPosition -= 5;
	...
	protected function getNoteT() {
		...
		$this->_page->setLineDashingPattern ( array (
				1,
				2 
		) );
		...
		$this->_page->setFont ( $this->_newTime, 11 );
		$this->_page->drawText ( $Control->convertDate ( $this->_DonneesPatient ['DATE_NAISSANCE'] ) . "  (" . $this->nbAnnees ( $this->_DonneesPatient ['DATE_NAISSANCE'], $date_actu ) . " ans)", $this->_leftMargin + 240, $this->_yPosition );
		...
		while ( $this->_yPosition > 70 ) {
			if ($i == 0) {
				...
				$this->_page->drawText ( 'Hopital d\'accueil :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $this->_DonneesDemande ['NomHopital'] ), $this->_leftMargin + 120, $this->_yPosition );
			}
			if ($i == 1) {
				$this->_page->setFont ( $this->_newTimeGras, 14 );
				$this->_page->drawText ( 'Service d\'accueil :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $this->_DonneesDemande ['NomService'] ), $this->_leftMargin + 120, $this->_yPosition );
			}
			if ($i == 2) {
				$this->_page->setFont ( $this->_newTimeGras, 14 );
				$this->_page->drawText ( 'Motif du transfert :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $tab [1] ), $this->_leftMargin + 130, $this->_yPosition );
			}
			if ($i == 3) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [2], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 4) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $tab [3] ), $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 5) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $tab [4] ), $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 6) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $tab [5] ), $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 7) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $tab [6] ), $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 8) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $tab [7] ), $this->_leftMargin, $this->_yPosition );
			}
		...
		$this->_page->setFont ( $this->_policeContenu, 14 );
		$this->_page->drawText ( $this->_DonneesMedecin ['prenomMedecin'] . ' ' . $this->_DonneesMedecin ['nomMedecin'], $this->_leftMargin + 370, $this->_yPosition + 90 );
	}
	public function getPiedPage() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Tï¿½lï¿½phone: 33 726 25 36   BP: 25 000', $this->_leftMargin, $this->_pageWidth - ($this->_yPosition + 503) );
		
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Consultation numï¿½ro: ', $this->_leftMargin + 370, $this->_pageWidth - ($this->_yPosition + 503) );
		$this->_page->setFont ( $this->_newTimeGras, 11 );
		$this->_page->drawText ( $this->_id_cons, $this->_leftMargin + 465, $this->_pageWidth - ($this->_yPosition + 503) );
	}
}