...
class TransfertPdf {
	...
	public function getPiedPage() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'T�l�phone: 33 726 25 36   BP: 25 000', $this->_leftMargin, $this->_pageWidth - ($this->_yPosition + 503) );
		
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Consultation num�ro: ', $this->_leftMargin + 370, $this->_pageWidth - ($this->_yPosition + 503) );
