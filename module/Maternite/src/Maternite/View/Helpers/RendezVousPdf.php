...
class RendezVousPdf {
	...
	public function setEnTete() {
		...
		$this->_page->drawText ( 'RENDEZ-VOUS MEDICAL', $this->_leftMargin + 190, $this->_yPosition );
		$this->_yPosition -= 5;
	...
	protected function getNoteR() {
		...
		while ( $this->_yPosition > 70 ) {
			if ($i == 0) {
				...
				$this->_page->drawText ( 'Date :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $this->_DonneesDemande ['dateRv'], $this->_leftMargin + 60, $this->_yPosition );
			}
			if ($i == 1) {
				$this->_page->setFont ( $this->_newTimeGras, 14 );
				$this->_page->drawText ( 'Heure :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $this->_DonneesDemande ['heureRV'], $this->_leftMargin + 60, $this->_yPosition );
			}
			if ($i == 2) {
				$this->_page->setFont ( $this->_newTimeGras, 14 );
				$this->_page->drawText ( 'Motif :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [1], $this->_leftMargin + 60, $this->_yPosition );
			}
			if ($i == 3) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
			...
			if ($i == 4) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [3], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 5) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [4], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 6) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [5], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 7) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [6], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 8) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [7], $this->_leftMargin, $this->_yPosition );
			}
