...
class HospitalisationPdf {
	...
	public function setEnTete() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Ministère de la santè et de l\'action sociale', $this->_leftMargin, $this->_pageHeight - 65 );
		$this->_page->setFont ( $this->_newTime, 10 );
		...
		$this->_page->drawText ( 'Demande d\'hospitalisation', $this->_leftMargin + 190, $this->_yPosition );
		$this->_yPosition -= 5;
	...
	protected function getNoteH() {
		...
		while ( $this->_yPosition > 70 ) {
			if ($i == 0) {
				...
				$this->_page->drawText ( 'Date fin prevue :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $this->_DonneesDemande ['date_fin_hospitalisation_prevue'] ), $this->_leftMargin + 120, $this->_yPosition );
			}
			if ($i == 1) {
				$this->_page->setFont ( $this->_newTimeGras, 14 );
