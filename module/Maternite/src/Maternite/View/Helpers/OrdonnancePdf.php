...
class OrdonnancePdf {
	...
	public function getPiedPage() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'T�l�phone: 33 726 25 36   BP: 24000', $this->_leftMargin, $this->_pageWidth - (100 + 390) );
		
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Consultation num�ro: ', $this->_leftMargin + 310, $this->_pageWidth - (100 + 390) );
