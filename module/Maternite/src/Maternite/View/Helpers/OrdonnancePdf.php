...
public function setEnTete() {
	...
	protected function getNoteMedicaments() {
		...
		$this->_page->drawText ( 'ORDONNANCE', $this->_leftMargin + 200, $this->_yPosition );
		$this->_yPosition -= 5;
		...
		$this->_page->drawText ( 'PRENOM & NOM :', $this->_leftMargin + 123, $this->_yPosition );
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $value ['PRENOM'] . '  ' . $value ['NOM'] ), $this->_leftMargin + 210, $this->_yPosition );
		// //-----------------------------------------------
		...
		$this->_yPosition -= 15; // allez a ligne suivante
		                         // ----------------------------------------------
		$this->_page->setFont ( $this->_newTimeGras, 9 );
		$this->_page->drawText ( 'SEXE :', $this->_leftMargin + 173, $this->_yPosition );
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $value ['SEXE'] ), $this->_leftMargin + 210, $this->_yPosition );
		// -----------------------------------------------
		$this->_yPosition -= 15; // allez a ligne suivante
		                         // ----- -----------------------------------------
		$this->_page->setFont ( $this->_newTimeGras, 9 );
		$this->_page->drawText ( 'DATE DE NAISSANCE :', $this->_leftMargin + 102, $this->_yPosition );
		$this->_page->setFont ( $this->_newTime, 10 );
		...
		$this->_page->drawText ( $dateNaissance . "  (" . $this->nbAnnees ( $value ['DATE_NAISSANCE'], $date_actu ) . " ans)", $this->_leftMargin + 210, $this->_yPosition );
		// -----------------------------------------------
		$this->_yPosition -= 15; // allez a ligne suivante
		                         // ----------------------------------------------
		$this->_page->setFont ( $this->_newTimeGras, 9 );
		$this->_page->drawText ( 'ADRESSE :', $this->_leftMargin + 155, $this->_yPosition );
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $value ['ADRESSE'] ), $this->_leftMargin + 210, $this->_yPosition );
		// -----------------------------------------------
		...
		while ( $cpt < 14 ) {
			...
			while ( $d < $taille ) {
				$this->getNewItalique ();
				$this->_page->drawText ( $l ++ . ')', $this->_leftMargin, $this->_yPosition );
				$this->getNewTime ();
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $this->_Medicaments [$d ++] ), $this->_leftMargin + 20, $this->_yPosition );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $this->_Medicaments [$d ++] ), $this->_leftMargin + 180, $this->_yPosition );
				$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', $this->_Medicaments [$d ++] ) . ' ' . iconv ( 'UTF-8', 'ISO-8859-1', $this->_Medicaments [$d ++] ), $this->_leftMargin + 350, $this->_yPosition );
				
				$this->_page->drawLine ( $this->_leftMargin, $this->_yPosition, $this->_pageWidth - $this->_leftMargin, $this->_yPosition );
				$this->_yPosition -= $noteLineHeight - 10;
				$cpt ++;
				$this->_page->drawLine ( $this->_leftMargin + 20, $this->_yPosition, $this->_pageWidth - $this->_leftMargin - 320, $this->_yPosition );
		...
		// Ã©
		$this->_page->drawText ( iconv ( 'UTF-8', 'ISO-8859-1', 'Cachet et Signature' ), $this->_leftMargin + 350, $this->_yPosition );
	}
	public function getPiedPage() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Tï¿½lï¿½phone: 33 726 25 36   BP: 24000', $this->_leftMargin, $this->_pageWidth - (100 + 390) );
		
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Consultation numï¿½ro: ', $this->_leftMargin + 310, $this->_pageWidth - (100 + 390) );
		$this->_page->setFont ( $this->_newTimeGras, 11 );
		$this->_page->drawText ( $this->_id_cons, $this->_leftMargin + 405, $this->_pageWidth - (100 + 390) );
	}
}