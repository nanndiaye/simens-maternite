...
class TraitementChirurgicalPdf {
	...
	public function setEnTete() {
		...
		$this->_page->drawText ( 'Demande de visite prï¿½-anesthï¿½sique', $this->_leftMargin + 170, $this->_yPosition );
		$this->_yPosition -= 5;
	...
	protected function getNoteTC() {
		...
		while ( $this->_yPosition > 70 ) {
			if ($i == 0) {
				...
				$this->_page->drawText ( $tab [1], $this->_leftMargin + 80, $this->_yPosition );
			}
			if ($i == 1) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
			...
			if ($i == 3) {
				$this->_page->setFont ( $this->_newTimeGras, 13 );
				$this->_page->drawText ( 'Intervention prï¿½vue :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
			...
			if ($i == 4) {
				...
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( "", $this->_leftMargin + 120, $this->_yPosition );
			}
			if ($i == 5) {
				$this->_page->setFont ( $this->_newTimeGras, 13 );
				$this->_page->drawText ( 'VPA Nï¿½ :  ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( "", $this->_leftMargin + 60, $this->_yPosition );
			}
			if ($i == 6) {
				$this->_page->setFont ( $this->_newTimeGras, 13 );
				$this->_page->drawText ( 'Observation :  ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab2 [1], $this->_leftMargin + 90, $this->_yPosition );
			}
			if ($i == 7) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
			...
			if ($i == 8) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab2 [3], $this->_leftMargin, $this->_yPosition );
			}
			$i ++;
