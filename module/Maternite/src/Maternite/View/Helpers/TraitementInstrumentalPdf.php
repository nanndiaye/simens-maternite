...
class TraitementInstrumentalPdf {
	...
	public function setEnTete() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Ministère de la santï¿½ et de l\'action sociale', $this->_leftMargin, $this->_pageHeight - 65 );
		$this->_page->setFont ( $this->_newTime, 10 );
		...
		$this->_page->drawText ( 'Traitement Instrumental ', $this->_leftMargin + 180, $this->_yPosition );
		$this->_yPosition -= 5;
	...
	protected function getNoteTC() {
		...
		while ( $this->_yPosition > 70 ) {
			if ($i == 0) {
				...
				$this->_page->drawText ( 'Endoscopie interventionnelle :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab [1], $this->_leftMargin + 180, $this->_yPosition );
			}
			if ($i == 1) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
			...
			if ($i == 2) {
				$this->_page->setFont ( $this->_newTimeGras, 13 );
				$this->_page->drawText ( 'Radiologie interventionnelle :   ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab2 [1], $this->_leftMargin + 180, $this->_yPosition );
			}
			if ($i == 3) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab2 [2], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 4) {
				$this->_page->setFont ( $this->_newTimeGras, 13 );
				$this->_page->drawText ( 'Cardiologie interventionnelle :  ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab3 [1], $this->_leftMargin + 180, $this->_yPosition );
			}
			if ($i == 5) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab3 [2], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 6) {
				$this->_page->setFont ( $this->_newTimeGras, 13 );
				$this->_page->drawText ( 'Autres interventions :  ', $this->_leftMargin, $this->_yPosition );
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab4 [1], $this->_leftMargin + 140, $this->_yPosition );
			}
			if ($i == 7) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab4 [2], $this->_leftMargin, $this->_yPosition );
			}
			if ($i == 8) {
				$this->_page->setFont ( $this->_policeContenu, 14 );
				$this->_page->drawText ( $tab4 [3], $this->_leftMargin, $this->_yPosition );
			}
			$i ++;
	...
	public function getPiedPage() {
		...
		$this->_page->setFont ( $this->_newTime, 10 );
		$this->_page->drawText ( 'Tï¿½lï¿½phone: 33 726 25 36   BP: 24000', $this->_leftMargin, $this->_pageWidth - ($this->_yPosition + 503) );
