...
class SoinmodificationForm extends Form {
	public function __construct($name = null) {
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'M�dicament' ) 
				),
				'attributes' => array (
						'id' => 'medicament_m' 
				) 
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Fr�quence/jour' ) 
				),
				'attributes' => array (
						'id' => 'frequence_m' 
				) 
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Date de d�but d\'application' ) 
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Heures recommand�es' ),
						'value_options' => array (
								'01:00' => '01:00',
								'02:00' => '02:00',
								'03:00' => '03:00',
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8', 'Dur�e (en jour)' ) 
				),
				'attributes' => array (
						'id' => 'duree_m' 
				) 
