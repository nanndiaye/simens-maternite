    		...
    		'resources' => array(
    				...
    				'allow' => array(
    						...
    						'Maternite\Controller\Accouchement' => array(
    								'creer-dossier-patiente' => 'infirmier',
    								'ajouter-patiente' => 'infirmier',
    								'ajouter' =>'infirmier',
    								'enregistrement'=>'infirmier',
    								'liste-patient'=>'infirmier',
    								'liste-patient-ajax'=>'infirmier',
    								'info-patient'=>'infirmier',
    								'infos-patient'=>'infirmier',
    								'infos-patient_hospi'=>'infirmier',
    								'info-patient-admis'=>'infirmier',
    								'supprimer'=>'infirmier',
    								'supprimer-patient'=>'infirmier',
    								'modifier'=>'infirmier',
    								'admission-grossesse-normal'=>'infirmier',
    							    'admission-grossesse-pathologique'=>'infirmier',
    								'enregistrement-modification' =>'infirmier',
    								'complement-admission' =>'infirmier',
    								'admission' =>'infirmier',
    								'enregistrer-admission' =>'infirmier',
    								'liste-admission-ajax'=>'infirmier',
    								'declarer-deces'=>'infirmier',
    								'admission-test'=>'infirmier',
    								'liste-patients-admis'=>'infirmier',
    								'vue-patient-admis'=>'infirmier',
    								'accoucher'=>'infirmier',
    								'complement-accouchement'=>'infirmier',
    								'maj-accouchement'=>'infirmier',
    								'maj-complement-accouchement'=>'infirmier',
    								'update-complement-accouchement'=>'infirmier',
    								'impression-pdf'=>'infirmier',
    								'en-cours'=>'infirmier',
    								'liste-patient-encours-ajax'=>'infirmier',
    								'liste-soins-prescrits'=>'infirmier',
    								...
    								'liste-soins-visualisation-hosp'=>'infirmier',
    								'enregistrer-examen-du-jour'=>'infirmier',
    								'liste-examen-du-jour'=>'infirmier',
    								'liberer-patient'=>'infirmier',
    								'vue-examen-jour'=>'infirmier',
    						),
    						...
    						*/
    						...
    						'Consultation\Controller\Consultation' => array(
    								...
    								'en-cours' => array('medecin','infirmier'),
    								'liste-patient-encours-ajax' => array('medecin','infirmier'),
    								'info-patient' => array('medecin','infirmier'),
    								'detail-info-liberation-patient' => array('medecin','infirmier'),
    								'info-patient-hospi' => array('medecin','infirmier'),
    								'liste-soin' => array('medecin','infirmier'),
    								'supprimer-soin' => array('medecin','infirmier'),
    								'modifier-soin' => array('medecin','infirmier'),
    								'vue-soin-appliquer' => array('medecin','infirmier'),
    								'liberer-patient' => array('medecin','infirmier'),
    								'liste-soins-prescrits' => array('medecin','infirmier'),
    								'recherche-visualisation-consultation' =>array('medecin','infirmier'),
    								'enregistrer-examen-du-jour' => array('medecin','infirmier'),
    								'liste-examen-du-jour' => array('medecin','infirmier'),
    								'supprimer-examen-jour' => array('medecin','infirmier'),
    								'vue-examen-jour' => array('medecin','infirmier'),
    					...
    					/***
    						...
    						'Hospitalisation\Controller\Hospitalisation' => array(
    								...
    								'demande-hospitalisation' => array('major','infirmier'),
    								'liste-liberer-patients' => array('major','infirmier'),
    								'liste-liberer-patient-ajax' => array('major','infirmier'),
    								'liberation-patient' => array('major','infirmier'),
    								'liberer-patient_major' =>array('major','infirmier'),
    								'info-patient-liberer' => array('major','infirmier'),
    								
    								'liste-patient-ajax' => array('major','infirmier'),
    								'salles' => array('major','infirmier'),
    								'lits' => array('major','infirmier'),
    								'liste' => array('major','infirmier'),
    								'info-patient' => array('major','infirmier'),
    								'info-patient-hospi' => array('major','infirmier'),
    								
    								'gestion-des-lits' => array('major','infirmier'),
    								'liste-lits-ajax' => array('major','infirmier'),
    								'occuper-lit' => array('major','infirmier'),
    								'liberer-lit' => array('major','infirmier'),
    								'etat-lit' => array('major','infirmier'),
    								'information-patient' => array('major','infirmier'),
    								'info-lit-salle-batiment' => array('major','infirmier'),
