...
//-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*--*-*-*-*-*-*-*-*-*--*-*-*-*--*-*-*-*-*-**--*-**-*--**-*-*-*-*-*-*-*-*-*-*-*-*-*--**-*-*-*-*-	
 ...
 function dep1_NouvelleG(){
		$('#depliantNouvelleGrossesse').click(function(){
			$("#depliantNouvelleGrossesse").replaceWith("<img id='depliantBandelette' style='cursor: pointer; position: absolute; padding-right: 120px;margin-top: 4px;width: 28px;' src='../img/light/plus.png' />");
			dep_NouvelleG();
		    $('#BUcheckbox2').animate({
		        height : 'toggle'
		    },1000);
	...
	function dep_NouvelleG(){ 
		$('#depliantNouvelleGrossesse').click(function(){
			$("#depliantNouvelleGrossesse").replaceWith("<img id='depliantBandelette' style='cursor: pointer; position: absolute; padding-right: 120px;margin-top: 4px;width: 28px;' src='../img/light/minus.png' />");
			dep1_NouvelleG();
		    $('#BUcheckbox2').animate({
		        height : 'toggle'
		    },1000);
