    ...
    function initialisation(){
    	...
    	( {
    					...
    					"sAjaxSource": ""+tabUrl[0]+"public/maternite/liste-patient-encours-ajax", 
    ...
    $("#terminersoin").click(function(){
    	...
    	vart=tabUrl[0]+'public/maternite/en-cours';
    ...
    function affichervue(id_demande_hospi){ 
    	...
    	var chemin = tabUrl[0]+'public/maternite/info-patient';
        $.ajax({
            type: 'POST',
            url: chemin ,
...
//  	    	return false;
    ...
    function administrerSoin(id_demande_hospi){
    	...
    	var id_personne = $("#"+id_demande_hospi+"idPers").val();
    	var chemin = tabUrl[0]+'public/maternite/info-patient-hospi';
        $.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function listeSoinsPrescrits(id_hosp) { 
    	var chemin = tabUrl[0]+'public/maternite/liste-soins-prescrits';
        $.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function listeSoins(id_hosp) { 
    	var chemin = tabUrl[0]+'public/maternite/liste-soin';
        $.ajax({
            type: 'POST',
            url: chemin ,
            data:{'id_hosp': id_hosp},
	    ...
	    buttons: {
	        "Oui": function() {
	            $( this ).dialog( "close" );
	            	...
	            	var chemin = tabUrl[0]+'public/maternite/en-cours';
	            	var id_sh = $('#id_sh').val();
    ...
    /************************************************************************************************************************/
        ...
        function vuesoin(id_sh){
            ...
            var chemin = tabUrl[0]+'public/maternite/vue-soin-appliquer';
            $.ajax({
                type: 'POST',
                url: chemin ,
                data:({'id_sh':id_sh}),
            	...
            	$( "#confirmationSup" ).dialog({
            	    ...
            	    buttons: {
            	        "Oui": function() {
            	        	 ...
            	        	 var chemin = tabUrl[0]+'public/maternite/supprimer-soin';
            	                $.ajax({
            	                    type: 'POST',
            	                    url: chemin ,
            	                    data:({'id_sh':id_sh}),
            ...
            /************************************************************************************************************************/
                ...
                function modifiersoin(id_sh , id_hosp){ 
                	modifiersoinPopup(id_sh,id_hosp);
                	 var chemin = tabUrl[0]+'public/maternite/modifier-soin';
 	                $.ajax({
 	                    type: 'POST',
 	                    url: chemin ,
 	                    data:({'id_sh':id_sh, 'id_hosp':id_hosp}),
    ...
    function affichervuedetailhospi(id_demande_hospi){
    	...
    	var chemin = tabUrl[0]+'public/maternite/detail-info-liberation-patient';
    	$.ajax({
    		type: 'POST',
    		url: chemin ,
    		data:{'id_personne':id_personne, 'id_cons':id_cons, 'encours':111, 'id_demande_hospi':id_demande_hospi},
    ...
    var theHREF = tabUrl[0]+"public/maternite/services";
	  ...
	  function ListeSoinsVisualisationHospi(){  
		  ...
		  $.ajax({
			  type: 'POST',
			  url: tabUrl[0]+"public/maternite/liste-soins-visualisation-hosp",
	  ...
	  function envoiDesDonnees(){
		  ...
		  $("#terminerExamenDuJour").click(function(){ 
			  ...
			  if(valid == true ) { 
				  ...
				  $.ajax({
					  type: 'POST',
					  url: tabUrl[0]+"public/maternite/enregistrer-examen-du-jour",
	  ...
	  function viderTousLesChamps(){
		  ...
		  //nouvelleGrossesse
		  //nouvelleGrossesses
		  $("#BUcheckbox2 input[name=nouvelleGrossesse]").attr('checked', false);
		  $("#BUcheckbox2 input[name=croixalbumine]").attr('checked', false);
		  $("#nouvelleGrossesse").toggle(false);
	  ...
	  function AppelListeExamensDuJoursHospi(id_hosp){
		  $.ajax({
			  type: 'POST',
			  url: tabUrl[0]+"public/maternite/liste-examen-du-jour",
			  data: {'id_hosp':id_hosp },
			  success: function(data) {
				  var result = jQuery.parseJSON(data);
	  ...
	  function visualiserExamenDuJour(id_examen_jour){
		  ...
		  formulaire.setAttribute("action","/simens/public/maternite/vue-examen-jour"); 
      	...
      	$( "#confirmationSuppExamenJour" ).dialog({
      	    ...
      	    buttons: {
      	        "Oui": function() {
      	        	 ...
      	        	 var chemin = tabUrl[0]+'public/maternite/supprimer-examen-jour';
      	                $.ajax({
      	                    type: 'POST',
      	                    url: chemin ,
