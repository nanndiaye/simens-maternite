...
//	            });
    ...
    function affichervue(idPatient, idAdmission){
    	...
    	var chemin = tabUrl[0]+'public/maternite/vue-patient-admis-bloc';
        $.ajax({
            type: 'POST',
            url: chemin ,
            data: $(this).serialize(),  
    ...
    function supprimerImagesAnnulation(){
    	...
    	var chemin = tabUrl[0]+'public/maternite/supprimer-images-sans-protocole';
    	$.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function initialisation(){
    	...
    	( {
    					...
    					"sAjaxSource": tabUrl[0]+"public/maternite/liste-patient-admis-bloc-ajax",
