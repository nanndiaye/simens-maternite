...
$(function(){
	...
	$("#bouton_Acte_modifier_demande1").toggle(false);
	//Au debut on affiche le bouton valider
	$("#bouton_Acte_valider_demande1").toggle(true);
	
	$("#bouton_Acte_valider_demande1 button").click(function(){
		//ON CACHE TOUT
		...
		$.ajax({
	        type: 'POST',
	        url: tabUrl[0]+'public/maternite/demande-acte',
...
function getTarifActe(id, pos){
	...
	$.ajax({
		type: 'POST',
		url: tabUrl[0]+'public/maternite/tarifacte',
		data:{'id':id},
