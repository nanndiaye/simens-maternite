...
function AppelLecteurVideo_Scanner(){
	...
	var chemin = tabUrl[0]+'public/maternite/afficher-video';
	$.ajax({
		url: chemin ,
		type: 'POST',
...
function scriptAjoutVideo(){
 	$(function () {
 	    $('#my_form_video').change(function (e) {
 	        ...
 	        var chemin = tabUrl[0]+'public/maternite/ajouter-video';
	        ...
	        $.ajax({
	            ...
	            success: function (response) { 
	            	...
	            	$.ajax({
        	        	url: tabUrl[0]+'public/maternite/inserer-bd-video',
...
function supprimerVideo(id) {
    var chemin = tabUrl[0]+'public/maternite/supprimer-video';
    $.ajax({
    	url: chemin ,
    	type: 'POST',
        data: {'id' : id},
