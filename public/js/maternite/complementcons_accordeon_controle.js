...
function ValiderDemandeActe(){
    $(function(){
        //Au debut on affiche pas le bouton modifier
        $("#Acte_modifier").toggle(false);
        //Au debut on affiche le bouton valider
        $("#Acte_valider").toggle(true);

        $("#Acte_valider button").click(function(){
            //ON CACHE TOUT
            ...
            $.ajax({
                ...
                success: function() {
                    ...
                    $("#Acte_modifier").toggle(true);
                    $("#Acte_valider").toggle(false);
                    return false;
                },
