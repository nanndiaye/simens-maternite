...
function visualiser(id){
	 confirmation(id);
	 var cle = id;
     var chemin = tabUrl[0]+'public/accouchement/liste-patient';
     $.ajax({
         type: 'POST',
         url: chemin ,
         data: $(this).serialize(),  
...
function initialisation(){
	...
	( {
		...
		"sAjaxSource": ""+tabUrl[0]+"public/accouchement/liste-patient-ajax", 
...
function scriptFactMajor(){
	...
	$('.termineradmission').click(function(){
		...
		if( temoin == 0 ){
			...
			var vart = tabUrl[0]+'public/accouchement/liste-patient';
