    ...
    function initialisation(){
    	...
    	( {
    					...
    					"sAjaxSource": ""+tabUrl[0]+"public/accouchement/liste-patient-encours-ajax", 
    ...
    $("#terminersoin").click(function(){
    	...
    	vart=tabUrl[0]+'public/accouchement/en-cours';
    ...
    function affichervue(id_demande_hospi){ 
    	...
    	var chemin = tabUrl[0]+'public/accouchement/infos-patient';
        $.ajax({
            type: 'POST',
            url: chemin ,
...
//  	    	return false;
    ...
    function administrerSoin(id_demande_hospi){
    	...
    	var id_personne = $("#"+id_demande_hospi+"idPers").val();
    	var chemin = tabUrl[0]+'public/accouchement/info-patient-hospi';
        $.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function listeSoinsPrescrits(id_hosp) { 
    	var chemin = tabUrl[0]+'public/accouchement/liste-soins-prescrits';
        $.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function listeSoins(id_hosp) { 
    	var chemin = tabUrl[0]+'public/accouchement/liste-soin';
        $.ajax({
            type: 'POST',
            url: chemin ,
            data:{'id_hosp': id_hosp},
	    ...
	    buttons: {
	        "Oui": function() {
	            $( this ).dialog( "close" );
	            	...
	            	var chemin = tabUrl[0]+'public/accouchement/en-cours';
	            	var id_sh = $('#id_sh').val();
    ...
    /************************************************************************************************************************/
        ...
        function vuesoin(id_sh){
            ...
            var chemin = tabUrl[0]+'public/accouchement/vue-soin-appliquer';
            $.ajax({
                type: 'POST',
                url: chemin ,
                data:({'id_sh':id_sh}),
            	...
            	$( "#confirmationSup" ).dialog({
            	    ...
            	    buttons: {
            	        "Oui": function() {
            	        	 ...
            	        	 var chemin = tabUrl[0]+'public/accouchement/supprimer-soin';
            	                $.ajax({
            	                    type: 'POST',
            	                    url: chemin ,
            	                    data:({'id_sh':id_sh}),
            ...
            /************************************************************************************************************************/
                ...
                function modifiersoin(id_sh , id_hosp){ 
                	modifiersoinPopup(id_sh,id_hosp);
                	 var chemin = tabUrl[0]+'public/accouchement/modifier-soin';
 	                $.ajax({
 	                    type: 'POST',
 	                    url: chemin ,
 	                    data:({'id_sh':id_sh, 'id_hosp':id_hosp}),
     ...
     function liberer(id_demande_hospi) {
       	var id_cons = $("#"+id_demande_hospi).val();
       	var id_personne = $("#"+id_demande_hospi+"idPers").val();
       	var chemin = tabUrl[0]+'public/accouchement/info-patient';
        $.ajax({
                type: 'POST',
                url: chemin ,
    ...
    function affichervuedetailhospi(id_demande_hospi){
    	...
    	var chemin = tabUrl[0]+'public/accouchement/detail-info-liberation-patient';
    	$.ajax({
    		type: 'POST',
    		url: chemin ,
    		data:{'id_personne':id_personne, 'id_cons':id_cons, 'encours':111, 'id_demande_hospi':id_demande_hospi},
    ...
    var theHREF = tabUrl[0]+"public/accouchement/services";
	  ...
	  function ListeSoinsVisualisationHospi(){  
		  ...
		  $.ajax({
			  type: 'POST',
			  url: tabUrl[0]+"public/accouchement/liste-soins-visualisation-hosp",
	  ...
	  function envoiDesDonnees(){
		  ...
		  $("#terminerExamenDuJour").click(function(){ 
			  ...
			  if(valid == true ) { 
				  ...
				  $.ajax({
					  type: 'POST',
					  url: tabUrl[0]+"public/accouchement/enregistrer-examen-du-jour",
	  ...
	  function AppelListeExamensDuJoursHospi(id_hosp){
		  $.ajax({
			  type: 'POST',
			  url: tabUrl[0]+"public/accouchement/liste-examen-du-jour",
			  data: {'id_hosp':id_hosp },
			  success: function(data) {
				  var result = jQuery.parseJSON(data);
	  ...
	  function visualiserExamenDuJour(id_examen_jour){
		  ...
		  formulaire.setAttribute("action","/simens/public/accouchement/vue-examen-jour"); 
      	...
      	$( "#confirmationSuppExamenJour" ).dialog({
      	    ...
      	    buttons: {
      	        "Oui": function() {
      	        	 ...
      	        	 var chemin = tabUrl[0]+'public/accouchement/supprimer-examen-jour';
      	                $.ajax({
      	                    type: 'POST',
      	                    url: chemin ,
